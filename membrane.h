 ...
 * membrane.h
 *
 *	Definition of a membrane structure
 *  Created on: 26-dic-2008
 *      Author: miguel
 */
...
struct _membrane {
  ...
  short int charge;
  Multiset multiset;
  struct _membrane * mother;
  struct _membrane * first_child;
  struct _membrane * next_sister;
  struct _membrane * prev_sister;
};

typedef struct _membrane Membrane;
